...
func (o *Duration) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *Duration) SetId(v string) {
	o.Id = &v
}

// GetExtension returns the Extension field value if set, zero value otherwise.
func (o *Duration) GetExtension() []Extension {
...
// and a boolean to check if the value has been set.
func (o *Duration) GetExtensionOk() ([]Extension, bool) {
	if o == nil || IsNil(o.Extension) {
		return nil, false
	}
...
func (o *Duration) HasExtension() bool {
	if o != nil && !IsNil(o.Extension) {
		return true
	}
...
func (o *Duration) SetExtension(v []Extension) {
	o.Extension = v
}

// GetValue returns the Value field value if set, zero value otherwise.
func (o *Duration) GetValue() float32 {
...
// and a boolean to check if the value has been set.
func (o *Duration) GetValueOk() (*float32, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// and a boolean to check if the value has been set.
func (o *Duration) GetComparatorOk() (*string, bool) {
	if o == nil || IsNil(o.Comparator) {
		return nil, false
	}
...
func (o *Duration) HasComparator() bool {
	if o != nil && !IsNil(o.Comparator) {
		return true
	}
...
func (o *Duration) SetComparator(v string) {
	o.Comparator = &v
}
...
func (o *Duration) GetSystem() string {
...
// and a boolean to check if the value has been set.
func (o *Duration) GetSystemOk() (*string, bool) {
	if o == nil || IsNil(o.System) {
		return nil, false
	}
...
func (o *Duration) HasSystem() bool {
	if o != nil && !IsNil(o.System) {
		return true
	}
...
func (o *Duration) SetSystem(v string) {
	o.System = &v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Duration) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *Duration) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Duration) SetCode(v string) {
	o.Code = &v
}
