...
func (o *Count) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *Count) SetId(v string) {
	o.Id = &v
}

// GetExtension returns the Extension field value if set, zero value otherwise.
func (o *Count) GetExtension() []Extension {
...
// and a boolean to check if the value has been set.
func (o *Count) GetExtensionOk() ([]Extension, bool) {
	if o == nil || IsNil(o.Extension) {
		return nil, false
	}
...
func (o *Count) HasExtension() bool {
	if o != nil && !IsNil(o.Extension) {
		return true
	}
...
func (o *Count) SetExtension(v []Extension) {
	o.Extension = v
}

// GetValue returns the Value field value if set, zero value otherwise.
func (o *Count) GetValue() float32 {
...
// and a boolean to check if the value has been set.
func (o *Count) GetValueOk() (*float32, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// and a boolean to check if the value has been set.
func (o *Count) GetComparatorOk() (*string, bool) {
	if o == nil || IsNil(o.Comparator) {
		return nil, false
	}
...
func (o *Count) HasComparator() bool {
	if o != nil && !IsNil(o.Comparator) {
		return true
	}
...
func (o *Count) SetComparator(v string) {
	o.Comparator = &v
}

// GetUnit returns the Unit field value if set, zero value otherwise.
func (o *Count) GetUnit() string {
...
// and a boolean to check if the value has been set.
func (o *Count) GetUnitOk() (*string, bool) {
	if o == nil || IsNil(o.Unit) {
		return nil, false
	}
	return o.Unit, true
...
func (o *Count) SetUnit(v string) {
	o.Unit = &v
}

// GetSystem returns the System field value if set, zero value otherwise.
func (o *Count) GetSystem() string {
...
// and a boolean to check if the value has been set.
func (o *Count) GetSystemOk() (*string, bool) {
	if o == nil || IsNil(o.System) {
		return nil, false
	}
...
func (o *Count) SetSystem(v string) {
	o.System = &v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Count) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *Count) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
