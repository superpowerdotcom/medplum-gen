...
func (o *PasswordChangeRequest) GetContained() []Resource {
...
// and a boolean to check if the value has been set.
func (o *PasswordChangeRequest) GetContainedOk() ([]Resource, bool) {
	if o == nil || IsNil(o.Contained) {
		return nil, false
	}
...
func (o *PasswordChangeRequest) SetContained(v []Resource) {
	o.Contained = v
}
