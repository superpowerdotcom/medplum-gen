...
// UserConfiguration User specific configuration for the Medplum application.
...
func NewUserConfiguration(resourceType string) *UserConfiguration {
...
func (o *UserConfiguration) GetResourceType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *UserConfiguration) GetResourceTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UserConfiguration) SetResourceType(v string) {
	o.ResourceType = v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *UserConfiguration) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *UserConfiguration) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *UserConfiguration) SetId(v string) {
	o.Id = &v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *UserConfiguration) GetMeta() Meta {
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetMetaOk() (*Meta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *UserConfiguration) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
func (o *UserConfiguration) SetMeta(v Meta) {
	o.Meta = &v
}

// GetImplicitRules returns the ImplicitRules field value if set, zero value otherwise.
func (o *UserConfiguration) GetImplicitRules() string {
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetImplicitRulesOk() (*string, bool) {
	if o == nil || IsNil(o.ImplicitRules) {
		return nil, false
	}
...
func (o *UserConfiguration) HasImplicitRules() bool {
	if o != nil && !IsNil(o.ImplicitRules) {
		return true
	}
...
func (o *UserConfiguration) SetImplicitRules(v string) {
	o.ImplicitRules = &v
}
...
func (o *UserConfiguration) HasLanguage() bool {
	if o != nil && !IsNil(o.Language) {
		return true
	}
...
func (o *UserConfiguration) GetText() Narrative {
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetTextOk() (*Narrative, bool) {
	if o == nil || IsNil(o.Text) {
		return nil, false
	}
	return o.Text, true
...
func (o *UserConfiguration) HasText() bool {
	if o != nil && !IsNil(o.Text) {
		return true
	}
...
func (o *UserConfiguration) SetText(v Narrative) {
	o.Text = &v
}
...
func (o *UserConfiguration) HasContained() bool {
	if o != nil && !IsNil(o.Contained) {
		return true
	}
...
func (o *UserConfiguration) GetExtension() []Extension {
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetExtensionOk() ([]Extension, bool) {
	if o == nil || IsNil(o.Extension) {
		return nil, false
	}
...
func (o *UserConfiguration) HasExtension() bool {
	if o != nil && !IsNil(o.Extension) {
		return true
	}
...
func (o *UserConfiguration) SetExtension(v []Extension) {
	o.Extension = v
}

// GetModifierExtension returns the ModifierExtension field value if set, zero value otherwise.
func (o *UserConfiguration) GetModifierExtension() []Extension {
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetModifierExtensionOk() ([]Extension, bool) {
	if o == nil || IsNil(o.ModifierExtension) {
		return nil, false
	}
...
func (o *UserConfiguration) HasModifierExtension() bool {
	if o != nil && !IsNil(o.ModifierExtension) {
		return true
	}
...
func (o *UserConfiguration) SetModifierExtension(v []Extension) {
	o.ModifierExtension = v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *UserConfiguration) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *UserConfiguration) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *UserConfiguration) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *UserConfiguration) SetName(v string) {
	o.Name = &v
}
...
func (o *UserConfiguration) HasMenu() bool {
	if o != nil && !IsNil(o.Menu) {
		return true
	}
...
func (o *UserConfiguration) HasSearch() bool {
	if o != nil && !IsNil(o.Search) {
		return true
	}
...
func (o *UserConfiguration) HasOption() bool {
	if o != nil && !IsNil(o.Option) {
		return true
	}
...
func (o *UserConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varUserConfiguration)
