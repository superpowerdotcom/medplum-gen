...
func (o *UserSecurityRequest) GetContained() []Resource {
...
// and a boolean to check if the value has been set.
func (o *UserSecurityRequest) GetContainedOk() ([]Resource, bool) {
	if o == nil || IsNil(o.Contained) {
		return nil, false
	}
...
func (o *UserSecurityRequest) SetContained(v []Resource) {
	o.Contained = v
}
