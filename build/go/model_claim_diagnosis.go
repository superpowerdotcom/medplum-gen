...
// checks if the ClaimDiagnosis type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClaimDiagnosis{}
...
// NewClaimDiagnosis instantiates a new ClaimDiagnosis object
...
// NewClaimDiagnosisWithDefaults instantiates a new ClaimDiagnosis object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewClaimDiagnosisWithDefaults() *ClaimDiagnosis {
	this := ClaimDiagnosis{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *ClaimDiagnosis) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ClaimDiagnosis) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ClaimDiagnosis) SetId(v string) {
	o.Id = &v
}

// GetExtension returns the Extension field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetExtension() []Extension {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetExtensionOk() ([]Extension, bool) {
	if o == nil || IsNil(o.Extension) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasExtension() bool {
	if o != nil && !IsNil(o.Extension) {
		return true
	}
...
func (o *ClaimDiagnosis) SetExtension(v []Extension) {
	o.Extension = v
}

// GetModifierExtension returns the ModifierExtension field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetModifierExtension() []Extension {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetModifierExtensionOk() ([]Extension, bool) {
	if o == nil || IsNil(o.ModifierExtension) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasModifierExtension() bool {
	if o != nil && !IsNil(o.ModifierExtension) {
		return true
	}
...
func (o *ClaimDiagnosis) SetModifierExtension(v []Extension) {
	o.ModifierExtension = v
}

// GetSequence returns the Sequence field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetSequence() float32 {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetSequenceOk() (*float32, bool) {
	if o == nil || IsNil(o.Sequence) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasSequence() bool {
	if o != nil && !IsNil(o.Sequence) {
		return true
	}
...
func (o *ClaimDiagnosis) SetSequence(v float32) {
	o.Sequence = &v
}

// GetDiagnosisCodeableConcept returns the DiagnosisCodeableConcept field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetDiagnosisCodeableConcept() CodeableConcept {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetDiagnosisCodeableConceptOk() (*CodeableConcept, bool) {
	if o == nil || IsNil(o.DiagnosisCodeableConcept) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasDiagnosisCodeableConcept() bool {
	if o != nil && !IsNil(o.DiagnosisCodeableConcept) {
		return true
	}
...
func (o *ClaimDiagnosis) SetDiagnosisCodeableConcept(v CodeableConcept) {
	o.DiagnosisCodeableConcept = &v
}

// GetDiagnosisReference returns the DiagnosisReference field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetDiagnosisReference() Reference {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetDiagnosisReferenceOk() (*Reference, bool) {
	if o == nil || IsNil(o.DiagnosisReference) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasDiagnosisReference() bool {
	if o != nil && !IsNil(o.DiagnosisReference) {
		return true
	}
...
func (o *ClaimDiagnosis) SetDiagnosisReference(v Reference) {
	o.DiagnosisReference = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetType() []CodeableConcept {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetTypeOk() ([]CodeableConcept, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ClaimDiagnosis) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *ClaimDiagnosis) SetType(v []CodeableConcept) {
	o.Type = v
}

// GetOnAdmission returns the OnAdmission field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetOnAdmission() CodeableConcept {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetOnAdmissionOk() (*CodeableConcept, bool) {
	if o == nil || IsNil(o.OnAdmission) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasOnAdmission() bool {
	if o != nil && !IsNil(o.OnAdmission) {
		return true
	}
...
func (o *ClaimDiagnosis) SetOnAdmission(v CodeableConcept) {
	o.OnAdmission = &v
}

// GetPackageCode returns the PackageCode field value if set, zero value otherwise.
func (o *ClaimDiagnosis) GetPackageCode() CodeableConcept {
...
// and a boolean to check if the value has been set.
func (o *ClaimDiagnosis) GetPackageCodeOk() (*CodeableConcept, bool) {
	if o == nil || IsNil(o.PackageCode) {
		return nil, false
	}
...
func (o *ClaimDiagnosis) HasPackageCode() bool {
	if o != nil && !IsNil(o.PackageCode) {
		return true
	}
...
func (o *ClaimDiagnosis) SetPackageCode(v CodeableConcept) {
	o.PackageCode = &v
}

func (o ClaimDiagnosis) MarshalJSON() ([]byte, error) {
...
func (o ClaimDiagnosis) ToMap() (map[string]interface{}, error) {
...
type NullableClaimDiagnosis struct {
	value *ClaimDiagnosis
	isSet bool
}

func (v NullableClaimDiagnosis) Get() *ClaimDiagnosis {
	return v.value
}

func (v *NullableClaimDiagnosis) Set(val *ClaimDiagnosis) {
	v.value = val
	v.isSet = true
}

func (v NullableClaimDiagnosis) IsSet() bool {
	return v.isSet
}

func (v *NullableClaimDiagnosis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClaimDiagnosis(val *ClaimDiagnosis) *NullableClaimDiagnosis {
	return &NullableClaimDiagnosis{value: val, isSet: true}
}

func (v NullableClaimDiagnosis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClaimDiagnosis) UnmarshalJSON(src []byte) error {
	v.isSet = true
